...
@interface Example1ViewController () <ZLPhotoPickerBrowserViewControllerDataSource,ZLPhotoPickerBrowserViewControllerDelegate>
...
- (MLPhotoBrowserPhoto *) photoBrowser:(MLPhotoBrowserViewController *)pickerBrowser photoAtIndexPath:(NSIndexPath *)indexPath{
    MLPhotoBrowserAssets *imageObj = [self.photos objectAtIndex:indexPath.row];
    // 包装下imageObj 成 ZLPhotoPickerBrowserPhoto 传给数据源
    MLPhotoBrowserPhoto *photo = [MLPhotoBrowserPhoto photoAnyImageObjWith:imageObj];
